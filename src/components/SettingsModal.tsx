...
import { MessageCircleMoreIcon, PaletteIcon, SettingsIcon, SparkleIcon, SparklesIcon, WandSparklesIcon, SwordsIcon, ListMinusIcon, ChessKnightIcon, TriangleAlertIcon, MountainSnowIcon } from './icons'
import {
...
interface SettingsModalProps {
  ...
  /** Whether scenes should also maintain rolling relationship summaries. */
  ...
  /** Called when the user toggles rolling relationship summaries for scenes. */
        ...
        nav={(
          ...
          >
            ...
            <SettingsSectionTab
              id="scene"
              label="Scene"
              description="Per-scene behavior"
        ...
        panel={(
          <div className="settings-modal__panel">
            {activeSection === 'interface' ? (
              ...
              <section className="settings-modal__section">
                ...
                <div className="settings-modal__warning" role="alert" aria-live="polite">
                  ...
                  <PromptTemplateEditor
                    ...
                    hint="Used when generating the relationship-focused narrative summary from scene transcripts."
              ...
              <section className="settings-modal__section">
                <div>
                  <h2 className="settings-modal__heading">Scene</h2>
                  <p className="settings-modal__subheading">
                    Scene behavior and context controls.
                  </p>
                </div>
                ...
                <div className="settings-modal__field-grid">
                  ...
                  <label className="settings-modal__toggle" htmlFor="settings-rolling-relationship-summaries">
                    <span className="settings-modal__toggle-body">
                      ...
                      <span className="settings-modal__field-hint">
                        Refresh the relationship-focused scene summary alongside rolling scene summaries.
                      </span>
                    </span>
                    <input
