...
/**
 * UserPlusIcon
 * Single-user add icon based on the provided Tabler-style path definition.
 *
 * @param props - Standard SVG props forwarded to the root element.
 */
...
/**
 * UserIcon
 * Single-user profile icon based on the provided Tabler-style path definition.
 *
 * @param props - Standard SVG props forwarded to the root element.
 */
...
/**
 * UsersIcon
 * Multi-user group icon based on the provided Tabler-style path definition.
 *
 * @param props - Standard SVG props forwarded to the root element.
 */
...
/**
 * WorldStarIcon
 * Global/world icon with featured star based on the provided Tabler-style path definition.
 *
 * @param props - Standard SVG props forwarded to the root element.
 */
export function WorldStarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
/**
 * UserCircleIcon
 * Circular user profile icon based on the provided Tabler-style path definition.
 *
 * @param props - Standard SVG props forwarded to the root element.
 */
 ...
 * Exit-from-square icon used for leaving the active campaign workspace.
 *
 * @param props - Standard SVG props forwarded to the root element.
 */
export function SquareArrowRightExitIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
